...
#brooklyn launch --app io.cloudsoft.marklogic.brooklynapplications.MarkLogicDemoApplication --location localhost

#brooklyn launch --app io.cloudsoft.marklogic.brooklynapplications.MarkLogicDemoApplication --location "byon:(hosts=ec2-54-224-37-173.compute-1.amazonaws.com,user=ec2-user)"
