...
brooklyn launch --app io.cloudsoft.marklogic.brooklynapplications.MarkLogicTestApplication --location "byon:(hosts='ec2-107-20-48-121.compute-1.amazonaws.com',user=ec2-user)"
