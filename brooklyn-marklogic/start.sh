...
#brooklyn launch --app io.cloudsoft.marklogic.brooklynapplications.MarkLogicTestApplication --location "byon:(hosts='ec2-23-22-133-15.compute-1.amazonaws.com,ec2-50-16-86-127.compute-1.amazonaws.com',user=ec2-user)"
